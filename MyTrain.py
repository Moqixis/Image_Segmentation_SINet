...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_model', type=str, default='/data/models/lhq/SINet/polyp/')
    parser.add_argument('--train_img_dir', type=str, default='/data/dataset/lhq/SINet/DataSet/TrainDataset/Image/')
    parser.add_argument('--train_gt_dir', type=str, default='/data/dataset/lhq/SINet/DataSet/TrainDataset/GT/')
